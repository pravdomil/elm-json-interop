...
import Utils.Utils exposing (fileToModuleName, firstToUpper, isIdType, letterByInt, toFunctionName, toJsonString, wrapInParentheses)


fromFile : File -> String
fromFile a =
    [ "module " ++ (a |> fileToModuleName |> String.join ".") ++ ".Encode exposing (..)"
    , ""
