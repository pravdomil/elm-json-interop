...
var $author$project$Main$Output = F3(
	function (code, stdout, stderr) {
		return {aA: code, a5: stderr, a6: stdout};
	});
...
var $author$project$Decode$fromCustomTypeConstructor = function (_v0) {
	...
	var tup = A2(
		...
		A2(
			...
			1),
		a.S);
	var name = $stil4m$elm_syntax$Elm$Syntax$Node$value(a.X);
...
var $author$project$Decode$fromCustomType = function (a) {
	var fail = '\n    _ -> fail <| \"I can\'t decode \" ++ ' + ($author$project$Utils$toJsonString(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(a.X)) + ' ++ \", what \" ++ tag ++ \" means?\"');
	var cases = A2(
		$elm$core$String$join,
		'\n    ',
...
var $author$project$Utils$Argument = F4(
	function (prefix, _char, suffix, disabled) {
		return {az: _char, bp: disabled, R: prefix, bM: suffix};
	});
	...
	function (argument, a) {
		var map = F2(
			function (i, b) {
				return A2(
					$author$project$Encode$fromTypeAnnotation,
					A4($author$project$Utils$Argument, '', (i + argument.az) + 1, '', false),
					b);
			});
		var _arguments = A2(
			$elm$core$String$join,
			...
			A2(
				...
				F2(
					function (i, _v7) {
						return $author$project$Utils$stringFromAlphabet((i + argument.az) + 1);
					}),
				a));
	...
	var name = A2(
		...
		$stil4m$elm_syntax$Elm$Syntax$TypeAnnotation$GenericType(
			$author$project$Utils$toJsonString(
				$stil4m$elm_syntax$Elm$Syntax$Node$value(a.X))));
...
var $author$project$TypeScript$fromType = function (a) {
	...
	var declaration = 'export type ' + ($stil4m$elm_syntax$Elm$Syntax$Node$value(a.X) + (generics + ' ='));
	return _Utils_ap(
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.a1, right.a1) < 0) ? 0 : ((_Utils_cmp(right.a1, left.a1) < 0) ? 2 : A2($elm$core$Basics$compare, left.aC, right.aC));
	});
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$FunctionImplementation = F3(
	function (name, _arguments, expression) {
		return {S: _arguments, Q: expression, X: name};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aB: col, bl: contextStack, aV: problem, a1: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.a1, s.aB, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.a1, s.aB, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aB: newCol, c: s.c, d: s.d, b: newOffset, a1: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aB: 1, c: s.c, d: s.d, b: s.b + 1, a1: s.a1 + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aB: s.aB + 1, c: s.c, d: s.d, b: newOffset, a1: s.a1, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aB: col, c: s0.c, d: s0.d, b: offset, a1: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.a1, s.aB, s);
	};
};
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aE: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(end),
								as: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(start)
							});
					}),
				A2(
					$stil4m$elm_syntax$Combine$andMap,
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {aB: col, c: context, d: indent, b: offset, a1: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.aM, s.b + 1, s.a1 + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.aM, firstOffset, s.a1, s.aB + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aG: $elm$parser$Parser$ExpectingVariable, aM: i.aM, a0: i.a0, as: i.as});
};
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.a1, s.aB, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.a1, s.aB, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aB: s.aB + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, a1: s.a1, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.a1, s.aB - (floatOffset + s.b), invalid, s.c));
		} else {
	...
	return $elm$parser$Parser$Advanced$number(
		{
			...
			aK: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.aK),
			aN: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.aN),
		...
		return $elm$parser$Parser$number(
			{
				...
				aK: $elm$core$Maybe$Just(hexf),
				aN: $elm$core$Maybe$Just(intf),
...
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {X: name, bO: typeAnnotation};
	});
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.bm).X),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {bk: constructors, bq: documentation, V: generics, X: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {bq: documentation, V: generics, X: name, bO: typeAnnotation};
	});
			...
			return A2(
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aE: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(end),
								as: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(start)
							});
					}),
				p);
		});
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{U: whereClauses.U, p: exp, r: name, av: whereClauses.av});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aB: col, aV: problem, a1: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.a1, p.aB, p.aV);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aB: 1, c: _List_Nil, d: 1, b: 0, a1: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $stil4m$elm_syntax$Elm$Inspector$defaultConfig = {Z: $stil4m$elm_syntax$Elm$Inspector$Continue, _: $stil4m$elm_syntax$Elm$Inspector$Continue, aa: $stil4m$elm_syntax$Elm$Inspector$Continue, ab: $stil4m$elm_syntax$Elm$Inspector$Continue, ac: $stil4m$elm_syntax$Elm$Inspector$Continue, ad: $stil4m$elm_syntax$Elm$Inspector$Continue, ae: $stil4m$elm_syntax$Elm$Inspector$Continue, af: $stil4m$elm_syntax$Elm$Inspector$Continue, ag: $stil4m$elm_syntax$Elm$Inspector$Continue, ah: $stil4m$elm_syntax$Elm$Inspector$Continue, ai: $stil4m$elm_syntax$Elm$Inspector$Continue, aj: $stil4m$elm_syntax$Elm$Inspector$Continue, ak: $stil4m$elm_syntax$Elm$Inspector$Continue, al: $stil4m$elm_syntax$Elm$Inspector$Continue, am: $stil4m$elm_syntax$Elm$Inspector$Continue, an: $stil4m$elm_syntax$Elm$Inspector$Continue, ao: $stil4m$elm_syntax$Elm$Inspector$Continue, ap: $stil4m$elm_syntax$Elm$Inspector$Continue};
...
var $stil4m$elm_syntax$Elm$Inspector$inspectImport = F3(
	function (config, imp, context) {
		return A4($stil4m$elm_syntax$Elm$Inspector$actionLambda, config.ae, $elm$core$Basics$identity, imp, context);
	});
...
var $stil4m$elm_syntax$Elm$Processing$Documentation$isDocumentationForRange = F2(
	function (range, _v0) {
		...
		if (A2($elm$core$String$startsWith, '{-|', commentText)) {
			var functionStartRow = range.as.a1;
			return _Utils_eq(commentRange.aE.a1 + 1, functionStartRow);
		} else {
			return false;
		}
	});
...
var $stil4m$elm_syntax$Elm$Processing$Documentation$postProcess = function (file) {
	return A3(
		...
		_Utils_update(
			...
			{
				ac: $stil4m$elm_syntax$Elm$Inspector$Post($stil4m$elm_syntax$Elm$Processing$Documentation$onFunction),
				an: $stil4m$elm_syntax$Elm$Inspector$Post($stil4m$elm_syntax$Elm$Processing$Documentation$onType),
				ao: $stil4m$elm_syntax$Elm$Inspector$Post($stil4m$elm_syntax$Elm$Processing$Documentation$onTypeAlias)
			}),
		file,
		file);
};
